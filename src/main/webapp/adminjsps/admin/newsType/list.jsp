...
<c:forEach items="${newsTypeList }" var="t">    
    	<tr style="text-align: center;" bordercolor="rgb(78,78,78)">
    		<td>${t.tname }</td>
    		<td>
    		  <a href="<c:url value='/admin/AdminNewsTypeServlet?method=editPre&tid=${t.tid }'/>">修改</a> |
    		  <a onclick="return confirm('您真要删除该分类吗?删除后该分类下的所有新闻将被删除！')" href="<c:url value='/admin/AdminNewsTypeServlet?method=delete&tid=${t.tid }'/>">删除</a>
    		</td>
    	</tr>
</c:forEach>
