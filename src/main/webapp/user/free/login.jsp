...
<form action="<c:url value='/UserServlet'/>?method=login" method="post" onsubmit="return submit1()" target="_top">
		...
		<table  height="121" border="0" align="center">
			<tbody>
				...
				<tr height="30">
					...
					<td align="left"><input type="text" name="name" id="name" value="${form.name }" onBlur="valName()"><span id="namespan"></span></td>
				</tr>
				<tr height="30">
					<td align="right">密码：</td>
					<td align="left"><input type="password" name="password" id="password" value="${form.password }" onBlur="valPassword()"><span id="passwordspan"></span></td>
				</tr>
				<tr height="30">
