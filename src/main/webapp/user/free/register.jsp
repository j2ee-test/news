	...
	<table  border="0" align="center">
		<tbody>
			...
			<tr height="30">
				...
				<td align="left"><input type="text" name="name" id="name" value="${form.name }" onBlur="valName()">
					<br><span id="namespan"  style="color: #E7060A;"></span></td>
			</tr>
			<tr height="30">
				<td align="right">密码：</td>
				<td align="left"><input type="password" name="password" id="password" value="${form.password }" onBlur="valPassword()">
