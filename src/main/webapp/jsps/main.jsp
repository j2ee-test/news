...
<table class="table" align="center">
	<tr style="background: #4682B4; height: 120px; ">
		<td colspan="2" align="center">
			<iframe frameborder="0" src="${base }/jsps/top.jsp" name="top"></iframe>
		</td>
	</tr>
	<tr>
		<td width="120" style="padding:5px;" align="center" valign="top">
			<iframe frameborder="0" width="120" src="${base }/NewsTypeServlet?method=findAll" name="left"></iframe>
		</td>
		<td>
			<iframe frameborder="0" src="${base }NewsServlet?method=findAll" name="body"></iframe>
		</td>
	</tr>
</table>
